...
**Proved 2026-09-05:** same seed-42 clip on one Spark, SHA `2d5e3d38…` **identical** to the two-Spark IB quality file (SSIM 1.0). Warm client **136 s** vs 55.5 s on two Sparks. Numbers: [docs/quality-speed.md](docs/quality-speed.md) (mirrored on the [2× repo](https://github.com/Coinupbtc/MiniMax-H3-2x-DGX-Spark/blob/main/docs/quality-speed.md)).
